...
export class CoursesComponent {
  ...
  categories = ['Tous', 'Technologie', 'Business', 'Science', 'Marketing', 'Langues', 'Santé'];
  ...
  allCourses: CourseCardData[] = [
    ...
    },
    {
      ...
      description: 'Maîtrisez les compétences essentielles en affaires, de la planification à l\'exécution.',
    ...
    },
    {
      ...
      description: 'Plongez dans le calcul, les statistiques et les concepts mathématiques avancés.',
    ...
    },
    {
      ...
      description: 'Apprenez à créer des campagnes marketing efficaces avec les réseaux sociaux et outils numériques.',
    ...
    },
    {
      ...
      description: 'Améliorez vos compétences en communication française pour le succès académique et professionnel.',
      thumbnail: 'https://images.unsplash.com/photo-1431274172761-fca41d930114?w=600&h=400&fit=crop',
      level: 'intermediate',
    ...
    },
    {
      ...
      description: 'Introduction aux systèmes de santé, soins aux patients et terminologie médicale.',
  ...
  get filteredCourses() {
    ...
    const levelMap: Record<string, string> = { 'Débutant': 'beginner', 'Intermédiaire': 'intermediate', 'Avancé': 'advanced' };
    ...
    return this.allCourses.filter(course => {
      ...
      const matchesLevel = level === 'Tous Niveaux' || course.level === levelMap[level];
  ...
  get hasActiveFilters() {
    return this.searchQuery() || this.selectedCategory() !== 'Tous' || this.selectedLevel() !== 'Tous Niveaux';
  }
}
